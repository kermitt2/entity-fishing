...
2. Add the stopwords file (``data/stopwords/bb.txt``)

3. Add the world frequencies file (``data/stopwords/bb.json.gz``)
    ...
    - Gzip the JSON file and rename it to ``bb.json.gz``
