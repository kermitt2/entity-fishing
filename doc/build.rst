...
The files generated by GRISP (see https://github.com/kermitt2/grisp?tab=readme-ov-file#final-hierarchy-of-files an example of hierarchy) should be used via the configuration:
