    ...
    public String eval(String corpus) {
        ...
        for (int i = 0; i < docs.getLength(); i++) {
            ...
            for (int j = 0; j < annotations.getLength(); j++) {
                ...
                // for the NER type generated by conll 2003 or by other system
            ...
            try {
                ...
                // for filling the entities by NER type generated by Grobid or original conll 2003 type
                for (NerdEntity entity : entities) {
                    ...
                    for(NerdEntity ref : referenceEntities) {
                        ...
                        if ( (start_ref == start) && (end_ref == end) ) {
                            entity.setNerConllType(ref.getNerConllType());
                            entity.setNerGrobidType(ref.getNerGrobidType());
                            entity.setNerdKidType(ref.getNerdKidType());
                            break;
                        }
                    }
                }
