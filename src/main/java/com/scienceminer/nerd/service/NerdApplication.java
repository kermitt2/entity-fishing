...
public class NerdApplication extends Application<NerdServiceConfiguration> {
    ...
    @Override
    public void initialize(Bootstrap<NerdServiceConfiguration> bootstrap) {
        GuiceBundle<NerdServiceConfiguration> guiceBundle = GuiceBundle.defaultBuilder(NerdServiceConfiguration.class)
    ...
    @Override
    public void run(NerdServiceConfiguration configuration, Environment environment) {
