...
public class DbLabelForPageList extends org.apache.hadoop.record.Record implements Serializable {
  ...
  static {
    ...
    _rio_recTypeInfo.addField("Labels", new org.apache.hadoop.record.meta.VectorTypeID(new org.apache.hadoop.record.meta.StructTypeID(com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage.getTypeInfo())));
  }
  
  private java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage> Labels;
  public DbLabelForPageList() { }
  public DbLabelForPageList(
    final java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage> Labels) {
    this.Labels = Labels;
  }
  ...
  public static void setTypeFilter(org.apache.hadoop.record.meta.RecordTypeInfo rti) {
    ...
    com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage.setTypeFilter(rti.getNestedStructTypeInfo("DbLabelForPage"));
  }
  ...
  public java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage> getLabels() {
    return Labels;
  }
  public void setLabels(final java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage> Labels) {
    this.Labels=Labels;
  }
  ...
  throws java.io.IOException {
    _rio_a.startRecord(this,_rio_tag);
    {
      ...
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len1; _rio_vidx1++) {
        com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage _rio_e1 = Labels.get(_rio_vidx1);
  ...
  throws java.io.IOException {
    _rio_a.startRecord(_rio_tag);
    {
      ...
      Labels=new java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage>();
      for (; !_rio_vidx1.done(); _rio_vidx1.incr()) {
        com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage _rio_e1;
        _rio_e1= new com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage();
  ...
  public int compareTo (final Object _rio_peer_) throws ClassCastException {
    ...
    int _rio_ret = 0;
    {
      ...
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len11 && _rio_vidx1<_rio_len21; _rio_vidx1++) {
        com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage _rio_e11 = Labels.get(_rio_vidx1);
        com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage _rio_e21 = _rio_peer.Labels.get(_rio_vidx1);
  ...
  public Object clone() throws CloneNotSupportedException {
    ...
    _rio_other.Labels = (java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLabelForPage>) this.Labels.clone();
    return _rio_other;
  }
  public int hashCode() {
    int _rio_result = 17;
