...
public class DbLabel extends org.apache.hadoop.record.Record implements Serializable {
  ...
  static {
    ...
    _rio_recTypeInfo.addField("Senses", new org.apache.hadoop.record.meta.VectorTypeID(new org.apache.hadoop.record.meta.StructTypeID(com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel.getTypeInfo())));
  }
  ...
  private java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel> Senses;
  public DbLabel() { }
  public DbLabel(
    ...
    final java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel> Senses) {
  ...
  public static void setTypeFilter(org.apache.hadoop.record.meta.RecordTypeInfo rti) {
    ...
    com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel.setTypeFilter(rti.getNestedStructTypeInfo("DbSenseForLabel"));
  }
  ...
  public java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel> getSenses() {
    return Senses;
  }
  public void setSenses(final java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel> Senses) {
    this.Senses=Senses;
  }
  ...
  throws java.io.IOException {
    ...
    _rio_a.writeLong(TextDocCount,"TextDocCount");
    {
      ...
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len1; _rio_vidx1++) {
        com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel _rio_e1 = Senses.get(_rio_vidx1);
  ...
  throws java.io.IOException {
    ...
    TextDocCount=_rio_a.readLong("TextDocCount");
    {
      ...
      Senses=new java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel>();
      for (; !_rio_vidx1.done(); _rio_vidx1.incr()) {
        com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel _rio_e1;
        _rio_e1= new com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel();
  ...
  public int compareTo (final Object _rio_peer_) throws ClassCastException {
    ...
    if (_rio_ret != 0) return _rio_ret;
    {
      ...
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len11 && _rio_vidx1<_rio_len21; _rio_vidx1++) {
        com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel _rio_e11 = Senses.get(_rio_vidx1);
        com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel _rio_e21 = _rio_peer.Senses.get(_rio_vidx1);
  ...
  public Object clone() throws CloneNotSupportedException {
    ...
    _rio_other.Senses = (java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel>) this.Senses.clone();
    return _rio_other;
  }
  public int hashCode() {
    int _rio_result = 17;
      ...
      try {
        ...
        }
        {
          ...
          for (int vidx1 = 0; vidx1 < vi1; vidx1++){
            int r = com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel.Comparator.slurpRaw(b,s,l);
            s+=r; l-=r;
          }
        }
        return (os - s);
      ...
      try {
        ...
        }
        {
          ...
          for (int vidx1 = 0; vidx1 < vi11 && vidx1 < vi21; vidx1++){
            int r1 = com.scienceminer.nerd.kb.model.hadoop.DbSenseForLabel.Comparator.compareRaw(b1,s1,l1,b2,s2,l2);
            if (r1 <= 0) { return r1; }
