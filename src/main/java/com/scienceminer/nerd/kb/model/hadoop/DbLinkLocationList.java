...
public class DbLinkLocationList extends org.apache.hadoop.record.Record implements Serializable {
  ...
  static {
    ...
    _rio_recTypeInfo.addField("LinkLocations", new org.apache.hadoop.record.meta.VectorTypeID(new org.apache.hadoop.record.meta.StructTypeID(com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation.getTypeInfo())));
  }
  
  private java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation> LinkLocations;
  public DbLinkLocationList() { }
  public DbLinkLocationList(
    final java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation> LinkLocations) {
  ...
  public static void setTypeFilter(org.apache.hadoop.record.meta.RecordTypeInfo rti) {
    ...
    com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation.setTypeFilter(rti.getNestedStructTypeInfo("DbLinkLocation"));
  }
  ...
  public java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation> getLinkLocations() {
    return LinkLocations;
  }
  public void setLinkLocations(final java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation> LinkLocations) {
    this.LinkLocations=LinkLocations;
  }
  ...
  throws java.io.IOException {
    _rio_a.startRecord(this,_rio_tag);
    {
      ...
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len1; _rio_vidx1++) {
        com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation _rio_e1 = LinkLocations.get(_rio_vidx1);
  ...
  throws java.io.IOException {
    _rio_a.startRecord(_rio_tag);
    {
      ...
      LinkLocations=new java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation>();
      for (; !_rio_vidx1.done(); _rio_vidx1.incr()) {
        com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation _rio_e1;
        _rio_e1= new com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation();
  ...
  public int compareTo (final Object _rio_peer_) throws ClassCastException {
    ...
    int _rio_ret = 0;
    {
      ...
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len11 && _rio_vidx1<_rio_len21; _rio_vidx1++) {
        com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation _rio_e11 = LinkLocations.get(_rio_vidx1);
        com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation _rio_e21 = _rio_peer.LinkLocations.get(_rio_vidx1);
  ...
  public Object clone() throws CloneNotSupportedException {
    ...
    _rio_other.LinkLocations = (java.util.ArrayList<com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation>) this.LinkLocations.clone();
    return _rio_other;
  }
  public int hashCode() {
    int _rio_result = 17;
      ...
      try {
        int os1 = s1;
        {
          ...
          for (int vidx1 = 0; vidx1 < vi11 && vidx1 < vi21; vidx1++){
            int r1 = com.scienceminer.nerd.kb.model.hadoop.DbLinkLocation.Comparator.compareRaw(b1,s1,l1,b2,s2,l2);
            if (r1 <= 0) { return r1; }
