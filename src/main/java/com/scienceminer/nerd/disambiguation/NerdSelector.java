...
//System.out.println("relatedness: " + related);
					...
					// for NER type generated by conll 2003
					String nerConllType = "MISC";
					if(candidate.getNerConllType() != null) {
						nerConllType = candidate.getNerConllType();
					}

					// for NER type generated by Grobid
					String nerGrobidType = null;
					if(candidate.getNerGrobidType() != null) {
						nerGrobidType = candidate.getNerGrobidType();
					}

					// for NER type generated by nerdKid
					String nerdKidType = "OTHER";
					if(candidate.getNerdKidType() != null) {
						nerdKidType = candidate.getNerdKidType();
					}

					// nerd score
					double nerd_score = ranker.getProbability(commonness, related, quality, bestCaseContext,
							embeddingsSimilarity, wikidataId, wikidataP31Id, nerConllType, nerdKidType, nerGrobidType);
