...
public class NerdCandidate implements Comparable<NerdCandidate> {
	...
	public String toString() {
		...
		// for ner conll type
		if (nerConllType != null) {
			buffer.append(nerConllType.toString() + "(nerConllType)\t");
		}

		// for ner Grobid type
		if (nerGrobidType != null) {
			buffer.append(nerGrobidType.toString() + "(nerGrobidType)\t");
		}

		// for nerdKid type
		if (nerdKidType != null) {
			buffer.append(nerdKidType.toString() + "(nerdKidType)\t");
		}
	...
	public NerdCandidate copy(NerdEntity entity) {
		...
		copy.setNerConllType(this.getNerConllType());
		copy.setNerGrobidType(this.getNerGrobidType());
		copy.setNerdKidType(this.getNerdKidType());
		return copy;
	}
}