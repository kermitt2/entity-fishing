...
public class NerdEntity implements Comparable<NerdEntity> {
	...
	private String nerConllType = null;

	// type of the entity by Grobid (person, location, etc.)
	private String nerGrobidType = null;

	// type of the entity by nerdKid
	private String nerdKidType = null;
	...
	public NerdEntity(String rawName, int start, int end, String nerConllType, String nerKidType) {
		this();
		this.rawName = rawName;
		this.setOffsetStart(start);
		this.setOffsetEnd(end);
		this.nerConllType = nerConllType;
		this.nerdKidType = nerKidType;
	}
	...
	public NerdEntity(NerdEntity entity) {
		...
		nerConllType = entity.getNerConllType();
		// for the NER type generated by Grobid
		nerGrobidType = entity.getNerGrobidType();
		// for the NER type generated by nerdKid
		nerdKidType = entity.getNerdKidType();
	...
	// for the NER type generated by conll
	public String getNerConllType() {
		return nerConllType;
	}

	public void setNerConllType(String nerConllType) {
		this.nerConllType = nerConllType;
	}

	// for the NER type generated by Grobid
	public String getNerGrobidType() {
		return nerGrobidType;
	}

	public void setNerGrobidType(String nerGrobidType) {
		this.nerGrobidType = nerGrobidType;
	}

	// for the NER type generated by nerdKid
	public String getNerdKidType() {
		return nerdKidType;
	}

	public void setNerdKidType(String nerdKidType) {
		this.nerdKidType = nerdKidType;
	}
