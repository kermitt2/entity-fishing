...
//System.out.println("check categories for " + sense.getId());							
						...
						// type NE generated by Grobid
//						candidate.setType(typeNE);
//
//						// Type NE predicted by Nerd-Kid
//						String predictedClass = UpperKnowledgeBase.getInstance().getPredictedClassByWikidataId(candidate.getWikidataId());
//						if (predictedClass != null) {
//							candidate.setTypeKid(predictedClass);
//						} else {
//							candidate.setTypeKid("NotNER");
//						}
