...
public class GenericRankerFeatureVector {
	...
	// ner type generated by Grobid
	public boolean Add_nerGrobid_type = false; // for the NER type generated by Grobid NER

	// ner type generated by conll
	public boolean Add_nerConll_type = false; // for the NER type generated by conll 2003

	// ner type generated by Nerd-Kid
	public boolean Add_nerdKid_type = false; // NER class as a result of Nerd-Kid's prediction
	...
	public String nerConll_type = "MISC";

	// for the NER type generated by Grobid
	public String nerGrobid_type = "NotNER";

	// for nerKid type
	public String nerdKid_type = "OTHER";
	...
	public String getArffHeader() throws IOException {
		...
		if (Add_ner_type)
			header.append("@attribute ner_type {NotNER, ACRONYM, ANIMAL, ARTIFACT, AWARD, BUSINESS, CONCEPT, CONCEPTUAL, CREATION, EVENT, IDENTIFIER, INSTALLATION, INSTITUTION, LEGAL, LOCATION, MEASURE, MEDIA, NATIONAL, ORGANISATION, PERIOD, PERSON, PERSON_TYPE, PLANT, SPORT_TEAM, SUBSTANCE, TITLE, WEBSITE, UNKNOWN}\n");

		// for the conll type
		if (Add_nerConll_type)
			header.append("@attribute nerConll_type {PER, LOC, ORG, MISC}\n");

        // for the Grobid NE type
		if (Add_nerGrobid_type)
			header.append("@attribute nerGrobid_type {NotNER, ACRONYM, ANIMAL, ARTIFACT, AWARD, BUSINESS, CONCEPT, CONCEPTUAL, CREATION, EVENT, IDENTIFIER, INSTALLATION, INSTITUTION, LEGAL, LOCATION, MEASURE, MEDIA, NATIONAL, ORGANISATION, PERIOD, PERSON, PERSON_TYPE, PLANT, SPORT_TEAM, SUBSTANCE, TITLE, WEBSITE, UNKNOWN}\n");

		// for nerdKid
		if (Add_nerdKid_type)
			header.append("@attribute nerKid_type {ACRONYM, ANIMAL, ARTIFACT, AWARD, BUSINESS, CONCEPT, CONCEPTUAL, CREATION, EVENT, IDENTIFIER, INSTALLATION, INSTITUTION, LEGAL, LOCATION, MEASURE, MEDIA, NATIONAL, ORGANISATION, PERIOD, PERSON, PERSON_TYPE, PLANT, SPORT_TEAM, SUBSTANCE, TITLE, WEBSITE, UNKNOWN, OTHER}\n");
	...
	public String printVector() {
		...
		// for conll type
		if (Add_nerConll_type) {
			res.append(","+nerConll_type);
		}
		// for Grobid ner type
		if (Add_nerGrobid_type) {
			res.append(","+nerGrobid_type);
		}
		// for nerdKid type
		if (Add_nerdKid_type) {
			res.append(","+nerdKid_type);
		}
		if (Add_ner_subtype) {
	...
	public double[] toVector(Attribute[] attributes) {
		...
		if (Add_nerGrobid_type) {
			...
			double val = 0.0;
			try {
				val = att.valueOf(nerGrobid_type);
			} catch (Exception e) {
				e.printStackTrace();
			}
			result[i] = val;
