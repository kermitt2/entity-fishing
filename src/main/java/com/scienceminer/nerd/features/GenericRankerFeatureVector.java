...
public class GenericRankerFeatureVector extends GenericFeatureVector {
	...
	public boolean Add_nerGrobid_type = false; // GROBID NER class
	...
	public boolean isSameClassType = false;
	...
	public String getArffHeader() throws IOException {
		...
		// for Nerd-Kid
		if (Add_nerKid_type)
			header.append("@attribute nerKid_type {NotNER, ACRONYM, ANIMAL, ARTIFACT, AWARD, BUSINESS, CONCEPT, CONCEPTUAL, CREATION, EVENT, IDENTIFIER, INSTALLATION, INSTITUTION, LEGAL, LOCATION, MEASURE, MEDIA, NATIONAL, ORGANISATION, PERIOD, PERSON, PERSON_TYPE, PLANT, SPORT_TEAM, SUBSTANCE, TITLE, WEBSITE, OTHER}\n");
