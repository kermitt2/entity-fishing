...
public class GenericRankerFeatureVector {
	...
	public boolean Add_isSameClassType = false; // true if every entity has the same class type which generated by Grobid as well as which generated by Nerd-Kid
	...
	public String getArffHeader() throws IOException {
		...
		// for Nerd-Kid
		if (Add_nerKid_type)
			header.append("@attribute nerKid_type {NotNER, NULL, PERSON, LOCATION, ORGANIZATION, ACRONYM, ANIMAL, ARTIFACT, BUSINESS, INSTITUTION, MEASURE, AWARD, CONCEPT, CONCEPTUAL, CREATION, EVENT, LEGAL, IDENTIFIER, INSTALLATION, MEDIA, NATIONAL, ORGANISATION, SUBSTANCE, PLANT, PERIOD, TITLE, PERSON_TYPE, WEBSITE, SPORT_TEAM, OTHER}\n");
