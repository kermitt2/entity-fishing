...
/**
 * A {@link WDatabase} for associating String keys with some generic record value object.
 *
 */
public abstract class StringRecordDatabase<Record> extends WDatabase<String, Record> {
	 ...
	 */
	public StringRecordDatabase(WEnvironment envi, DatabaseType type) {
		super(envi, type) ;
	}
	 ...
	 */
	public StringRecordDatabase(WEnvironment envi, DatabaseType type, String name) {
	...
	public void add(WEntry<String,Record> entry) {
	...
	public void loadFromCsvFile(File dataFile, boolean overwrite, ProgressTracker tracker) throws IOException  {
		...
		while ((line=input.readLine()) != null) {
			...
			WEntry<String,Record> entry = deserialiseCsvRecord(cri) ;
