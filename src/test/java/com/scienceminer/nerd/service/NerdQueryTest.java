...
public class NerdQueryTest {
    ...
    public void testSerialiseQueryAndBack() throws Exception {
        ...
        MatcherAssert.assertThat(json, is("{\"text\":\"bla bla\",\"mentions\":[\"ner\",\"wikipedia\"],\"customisation\":\"generic\",\"structure\":\"grobid\",\"documentLevelPropagation\":true}"));
    ...
    public void testToJson_checkDefaultValues_shouldWork() throws Exception {
        ...
        assertThat(jsonQuery, is("{\"text\":\"this is a test of a query\",\"mentions\":[\"ner\",\"wikipedia\"],\"customisation\":\"generic\",\"structure\":\"grobid\",\"documentLevelPropagation\":true}"));

        JSONParser anotherParser = new JSONParser();
        final JSONObject parsed = (JSONObject) anotherParser.parse(jsonQuery);
        assertThat(parsed.keySet().size(), is(5));
    ...
    public void testDeserialiseQueryAndBack() throws Exception {
        ...
        MatcherAssert.assertThat(nerdQuery.toJSON(), is("{\"text\":\"John\",\"mentions\":[\"ner\",\"wikipedia\"],\"customisation\":\"generic\",\"structure\":\"grobid\",\"documentLevelPropagation\":true}"));
