...
public class TestMediaWikiParser {
    ...
    @Test
    public void testWikiMedia2Text() throws Exception {
        ...
        testWikiMedia = "The '''United Kingdom European Union membership referendum''', also known as the '''EU referendum''', took place in the [[United Kingdom]] and [[Gibraltar]] on 23 June 2016. [[Member state of the European Union|Membership of the European Union]] has been a topic of debate in the [[United Kingdom]] since the country joined the [[European Economic Community]] (the Common Market), as it was known then, in 1973.";
        result = mediaWikiParser.toTextOnly(testWikiMedia);
        System.out.println(testWikiMedia);
        System.out.println(result);
    }
